...
const RegisterPage = () => {
    ...
    return (<ContainerT>
        <div className="lg:border-0 " >
            <h1 className=" text-3xl font-bold text-center mt-40  mb-10">CREATE ACCOUNT</h1>
                ...
                >
                    ...
                    <div className="relative mb-6">
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            type="text" id="input-group-1" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="example@.__.__" />
                    </div>
